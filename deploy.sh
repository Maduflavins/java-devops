...
sudo docker tag reeach-backend:latest registry.heroku.com/devops/web
if [ BRANCH_NAME == "master" ] && [ PULL_REQUEST == "false" ]; then sudo docker push registry.heroku.com/devops/web; fi
